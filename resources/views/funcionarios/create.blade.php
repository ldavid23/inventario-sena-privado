<!-- Modal -->
<div class="modal fade modal-lg" id="modalId" tabindex="-1" role="dialog" aria-labelledby="modalTitleId"
    aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <form action="{{ route('funcionarios.post') }}" method="post" class="row needs-validation ms-2" novalidate>
                @csrf
                <div class="modal-body">
                    <div class="container-fluid row">
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="text" class="form-control border-2 shadow-sm" id="nombre" name="nombre"
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <select class="form-select border-2 shadow-sm" id="coordinacion_id" name="coordinacion_id"
                                ...
                                <option value="{{ $row->id}}">{{ $row->coordinacion }}</option>
                                @endforeach
                            </select>
                            <div class="invalid-feedback fw-medium">
                                <i class="bi bi-exclamation-circle"></i> Este campo es obligatorio!
