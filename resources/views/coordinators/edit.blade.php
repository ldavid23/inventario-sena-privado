<div class="modal fade" id="edit{{ $coordinator->id }}" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1"
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form action="{{ route('coordinators.update', $coordinator->id) }}" method="POST"id="formEdit{{ $coordinator->id }}">
                @csrf
                <div class="modal-body">
                        <div class="col-md-12 mb-3">
                            <label for="rol" class="form-label fw-semibold">Coordinacion:</label>
                            <input type="text" class="form-control border-2 shadow-sm" name="coordinacion" id="coordinacion"  value="{{ $coordinator->coordinacion }}"  placeholder="Ingresar número de identificación" required>
                        ...
                        <div class="col-md-12 mb-3">
                            ...
                            <input type="text" class="form-control border-2 shadow-sm"name="encargado" id="encargado"   value="{{ $coordinator->encargado }}"  placeholder="Ingresar número de identificación" required>
                ...
                <div class="modal-footer">
                    ...
                    <button type="submit" class="btn btn-sm btn-success" onclick="validarForm({{ $coordinator->id }})">Modificar</button>
                </div>
            </form>
        </div>
    </div>
